...
mea_parser.add_argument('--lol_v2_real', action='store_true',  default=False,help='measure lol_v2_real dataset')
mea_parser.add_argument('--lol_v2_syn', action='store_true',  default=False,help='measure lol_v2_syn dataset')
...
def metrics(im_dir, label_dir, use_GT_mean):
    ...
    for item in tqdm(sorted(glob.glob(im_dir))):
        ...
        im2 = Image.open(label_dir + name.replace('low', 'normal')).convert('RGB')
        (h, w) = im2.size
        im1 = im1.resize((h, w))  
        im1 = np.array(im1) 
        im2 = np.array(im2)
...
if __name__ == '__main__':
    ...
    im_dir = r'weights/lolv1/*.png'
    label_dir = 'D:/Programs/Datasets/LOLdataset/eval/eval15/high/'
    if mea.lol_v2_real:
        im_dir = r'weights/lolv2-real/*.png'
        label_dir = 'D:/Programs/Datasets/LOL-v2/Real_captured/Test/Normal/'
    if mea.lol_v2_syn:
        im_dir = r'weights/lolv2-syn/*.png'
        label_dir = 'D:/Programs/Datasets/LOL-v2/Synthetic/Test/Normal/'
